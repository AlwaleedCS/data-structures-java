...
## Purpose
This repository is intended for educational purposes and serves as a personal
practice and portfolio of data structure implementations.

## Notes
Each data structure is implemented in its own folder to keep the code organized
